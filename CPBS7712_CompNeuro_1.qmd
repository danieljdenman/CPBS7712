...
![](./media/purple_martinotti_7_.png){.absolute width=300 top=150 left=50}
![](./media/synapse.png){.absolute width=200 left=20 top=100} 
![](./media/kv31.png){.absolute width=200 top=0 left=-50}
...
![](./media/triMouseDLC.gif){.absolute width=350 top=0 left=700} 
...
![](./media/Brodmann_areas_3D_.png){.absolute left=500 top=0 width=100}
![](./media/minnie_w_back_V3.png){.absolute left=375 top=0 width=100}
![](./media/purple_martinotti_7_.png){.absolute width=100 top=0 left=250}
![](./media/synapse.png){.absolute width=100 left=125 top=0} 
![](./media/kv31.png){.absolute width=100 top=0 left=0}
![](./media/arm_muscles.png){.absolute width=100 top=0 left=625} 
![](./media/triMouseDLC.gif){.absolute width=100 top=0 left=750} 

## {auto-animate=true auto-animate-easing="ease-in-out"}
![](./media/Brodmann_areas_3D_.png){.absolute left=600 top=0 width=100}
![](./media/minnie_w_back_V3.png){.absolute left=475 top=0 width=100}
![](./media/purple_martinotti_7_.png){.absolute left=350 top=0 width=100}
![](./media/synapse.png){.absolute left=225 top=0 width=100} 
![](./media/kv31.png){.absolute left=0 top=0 width=200}
![](./media/arm_muscles.png){.absolute left=725 top=0 width=100} 
![](./media/triMouseDLC.gif){.absolute left=850 top=0 width=100}  
...
![](./media/Brodmann_areas_3D_.png){.absolute left=700 top=0 width=100}
![](./media/minnie_w_back_V3.png){.absolute left=550 top=0 width=100}
![](./media/purple_martinotti_7_.png){.absolute left=300 top=0 width=200}
![](./media/synapse.png){.absolute left=225 top=0 width=100} 
![](./media/kv31.png){.absolute left=0 top=0 width=200}
![](./media/arm_muscles.png){.absolute left=825 top=0 width=100} 
![](./media/triMouseDLC.gif){.absolute left=950 top=0 width=100}  
...
![](./media/Brodmann_areas_3D_.png){.absolute left=700 top=0 width=100}
![](./media/minnie_w_back_V3.png){.absolute left=450 top=0 width=250}
![](./media/purple_martinotti_7_.png){.absolute left=325 top=0 width=100}
![](./media/synapse.png){.absolute left=125 top=0 width=250} 
![](./media/kv31.png){.absolute left=0 top=0 width=100}
![](./media/arm_muscles.png){.absolute left=825 top=0 width=100} 
![](./media/triMouseDLC.gif){.absolute left=950 top=0 width=100}  
...
## Connectivity  {auto-animate=true auto-animate-easing="ease-in-out"}
![](./media/Brodmann_areas_3D_.png){.absolute left=530 top=0 width=200}
![](./media/minnie_w_back_V3.png){.absolute left=375 top=0 width=100}
![](./media/purple_martinotti_7_.png){.absolute width=100 top=0 left=250}
![](./media/synapse.png){.absolute width=100 left=125 top=0} 
![](./media/kv31.png){.absolute width=100 top=0 left=0}
![](./media/arm_muscles.png){.absolute left=825 top=0 width=100} 
![](./media/triMouseDLC.gif){.absolute left=950 top=0 width=100}  
![](./media/conn_heirarchy.png){.absolute left=570 top=300}
...
![](./media/arm_muscles.png){.absolute left=825 top=0 width=100} 
![](./media/triMouseDLC.gif){.absolute left=950 top=0 width=100}  
![](./media/conn_graph.png){.absolute left=570 top=300}

## Behavior {auto-animate=true auto-animate-easing="ease-in-out"}
![](./media/Brodmann_areas_3D_.png){.absolute left=550 top=0 width=100}
![](./media/minnie_w_back_V3.png){.absolute left=425 top=0 width=100}
![](./media/purple_martinotti_7_.png){.absolute left=300 top=0 width=100}
![](./media/synapse.png){.absolute left=200 top=0 width=100} 
![](./media/kv31.png){.absolute left=0 top=0 width=100}
![](./media/arm_muscles.png){.absolute left=625 top=0 width=200} 
![](./media/triMouseDLC.gif){.absolute left=825 top=0 width=200}  
...
![](./media/Brodmann_areas_3D_.png){.absolute left=580 top=200 width=125}
![](./media/minnie_w_back_V3.png){.absolute left=350 top=200 width=200}
![](./media/purple_martinotti_7_.png){.absolute width=100 top=200 left=175}
![](./media/synapse.png){.absolute width=100 left=50 top=200} 
...
![](./media/Brodmann_areas_3D_.png){.absolute left=580 top=00 width=125}
![](./media/minnie_w_back_V3.png){.absolute left=350 top=00 width=200}
![](./media/purple_martinotti_7_.png){.absolute width=100 top=00 left=175}
![](./media/synapse.png){.absolute width=100 left=50 top=00} 
![](./media/kv31.png){.absolute width=100 top=0 left=0}
![](./media/arm_muscles.png){.absolute left=825 top=00 width=100} 
![](./media/triMouseDLC.gif){.absolute left=950 top=00 width=100}  
